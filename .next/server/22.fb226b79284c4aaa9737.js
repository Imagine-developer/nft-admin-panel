...
class Admins_Contact extends external_react_["Component"] {
  async componentDidMount() {
    const admins = await external_axios_default.a.get('https://desolate-inlet-76011.herokuapp.com/admins');
    this.setState({
      allContact: admins,
      contactList: admins
    });
  ...
  constructor() {
    ...
    _defineProperty(this, "onDeleteContact", async data => {
      const res = await external_axios_default.a.delete('https://desolate-inlet-76011.herokuapp.com/admin/' + data._id);
      this.setState({
