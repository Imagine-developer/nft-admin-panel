...
class Contact extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  async componentWillMount() {
    ...
    */
    const res = await axios__WEBPACK_IMPORTED_MODULE_8___default.a.get('https://desolate-inlet-76011.herokuapp.com/whitelist');
    this.setState({
  ...
  constructor() {
    ...
    _defineProperty(this, "onSaveContact", async data => {
      const web3 = new web3__WEBPACK_IMPORTED_MODULE_10___default.a(web3__WEBPACK_IMPORTED_MODULE_10___default.a.givenProvider || new web3__WEBPACK_IMPORTED_MODULE_10___default.a.providers.WebsocketProvider("wss://rinkeby.infura.io/ws/v3/62b7d9f5f9844b8582f51e4b5c906c09"));
      ...
      const whitelisted = await axios__WEBPACK_IMPORTED_MODULE_8___default.a.post('https://desolate-inlet-76011.herokuapp.com/whitelist', data);
      const metamask = await Object(_Tokens_metamask__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])();
      const walletAddress = metamask.userAddress;
      const wallet = metamask.web3;
      ...
      this.setState({
        contactList: [...this.state.contactList, whitelisted],
    ...
    _defineProperty(this, "onDeleteContact", async data => {
      const res = await axios__WEBPACK_IMPORTED_MODULE_8___default.a.delete('https://desolate-inlet-76011.herokuapp.com/whitelist/' + data._id);
      this.setState({
