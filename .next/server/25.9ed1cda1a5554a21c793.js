...
// CONCATENATED MODULE: ./routes/Mail/data/mails.js
...
// CONCATENATED MODULE: ./routes/Mail/data/folders.js
...
// CONCATENATED MODULE: ./routes/Mail/data/filters.js
...
// CONCATENATED MODULE: ./routes/Mail/data/labels.js
...
// CONCATENATED MODULE: ./routes/Mail/data/options.js
...
// CONCATENATED MODULE: ./app/components/mail/SupportDetail/index.js
var __jsx = external_react_default.a.createElement;
...
const SupportDetail_options = ['Reply', 'Forward', 'Print'];

class SupportDetail_MailDetail extends external_react_default.a.Component {
  constructor(...args) {
    super(...args);
    ...
    _defineProperty(this, "optionMenu", () => {
      return __jsx(external_antd_["Menu"], {
        id: "long-menu"
      }, SupportDetail_options.map(option => __jsx(external_antd_["Menu"].Item, {
        key: option
      }, option)));
    });
  }
  ...
  render() {
    ...
    }), __jsx("p", null, mail.description))));
  }

}

/* harmony default export */ var SupportDetail = (SupportDetail_MailDetail);
...
// EXTERNAL MODULE: ./routes/Mail/index.css
var routes_Mail = __webpack_require__("qNBI");

// CONCATENATED MODULE: ./routes/Mail/index.js
var Mail_jsx = external_react_default.a.createElement;

function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { Mail_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function Mail_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class Mail_Mail extends external_react_["PureComponent"] {
  constructor() {
    super();

    Mail_defineProperty(this, "onDeleteMail", () => {
    ...
    Mail_defineProperty(this, "getNavFolders", () => {
      return folders.map((folder, index) => Mail_jsx("li", {
        key: index,
        onClick: () => {
      ...
      }), Mail_jsx("span", null, folder.title))));
    });

    Mail_defineProperty(this, "onFolderMenuItemSelect", e => {
      const id = +e.key;
      const mails = this.state.allMail.map(mail => mail.selected && mail.folder === this.state.selectedFolder ? _objectSpread(_objectSpread({}, mail), {}, {
        folder: id,
        selected: false
    ...
    Mail_defineProperty(this, "onLabelMenuItemSelect", e => {
      const id = +e.key;
    ...
    Mail_defineProperty(this, "handleRequestClose", () => {
      this.setState({
        composeMail: false,
        showMessage: false
      });
    ...
    Mail_defineProperty(this, "getNavFilters", () => {
      return filters.map((filter, index) => Mail_jsx("li", {
        key: index,
        onClick: () => {
      ...
      }), Mail_jsx("span", null, filter.title))));
    });

    Mail_defineProperty(this, "onOptionMenuItemSelect", e => {
      switch (e.key) {
        case 'All':
    ...
    Mail_defineProperty(this, "getAllMail", () => {
    ...
    Mail_defineProperty(this, "getUnselectedAllMail", () => {
      let mails = this.state.allMail.map(mail => mail.folder === this.state.selectedFolder ? _objectSpread(_objectSpread({}, mail), {}, {
        selected: false
      }) : mail);
      this.setState({
    ...
    Mail_defineProperty(this, "getReadMail", () => {
      let selectedMail = 0;
    ...
    Mail_defineProperty(this, "getUnreadMail", () => {
      let selectedMail = 0;
      let mails = this.state.allMail.filter(mail => mail.folder === this.state.selectedFolder);
      mails = mails.map(mail => {
        if (!mail.read) {
    ...
    Mail_defineProperty(this, "getStarredMail", () => {
      let selectedMail = 0;
      let mails = this.state.allMail.filter(mail => mail.folder === this.state.selectedFolder);
      mails = mails.map(mail => {
        if (mail.starred) {
    ...
    Mail_defineProperty(this, "getUnStarredMail", () => {
      let selectedMail = 0;
    ...
    Mail_defineProperty(this, "getImportantMail", () => {
      let selectedMail = 0;
      let mails = this.state.allMail.filter(mail => mail.folder === this.state.selectedFolder && mail.folder === this.state.selectedFolder);
      mails = mails.map(mail => {
        if (mail.important) {
    ...
    Mail_defineProperty(this, "getUnimportantMail", () => {
      let selectedMail = 0;
      let mails = this.state.allMail.filter(mail => mail.folder === this.state.selectedFolder && mail.folder === this.state.selectedFolder);
      mails = mails.map(mail => {
        if (!mail.important) {
    ...
    Mail_defineProperty(this, "getNavLabels", () => {
      return labels.map((label, index) => Mail_jsx("li", {
        key: index,
        onClick: () => {
      ...
      }), Mail_jsx("span", null, label.title))));
    });

    Mail_defineProperty(this, "searchMail", searchText => {
      if (searchText === '') {
        this.setState({
    ...
    Mail_defineProperty(this, "displayMail", (currentMail, folderMails, noContentFoundMessage) => {
      return Mail_jsx("div", {
        className: "gx-module-box-column"
      }, currentMail === null ? folderMails.length === 0 ? Mail_jsx("div", {
        className: "gx-no-content-found gx-text-light gx-d-flex gx-align-items-center gx-justify-content-center"
      }, noContentFoundMessage) : Mail_jsx(MailList["a" /* default */], {
        mails: folderMails,
    ...
    Mail_defineProperty(this, "getMailActions", () => {
      return Mail_jsx("div", {
        className: "gx-flex-row gx-align-items-center"
      }, Mail_jsx(external_antd_["Dropdown"], {
    ...
    Mail_defineProperty(this, "optionMenu", () => Mail_jsx(external_antd_["Menu"], {
      id: "option-menu",
      onClick: this.onOptionMenuItemSelect.bind(this)
    }, options.map(option => Mail_jsx(external_antd_["Menu"].Item, {
      key: option.title
    }, option.title))));

    Mail_defineProperty(this, "folderMenu", () => Mail_jsx(external_antd_["Menu"], {
      id: "folder-menu",
      onClick: this.onFolderMenuItemSelect.bind(this)
    }, folders.map(folder => Mail_jsx(external_antd_["Menu"].Item, {
      key: folder.id
    }, folder.title))));

    Mail_defineProperty(this, "labelMenu", () => Mail_jsx(external_antd_["Menu"], {
      id: "label-menu",
      onClick: this.onLabelMenuItemSelect.bind(this)
    }, labels.map(label => Mail_jsx(external_antd_["Menu"].Item, {
      key: label.id
    }, label.title))));
  ...
  async componentDidMount() {
    const result = await external_axios_default.a.get('https://desolate-inlet-76011.herokuapp.com/reports');
  ...
  render() {
    ...
    }, Mail_jsx(external_antd_["Drawer"], {
      placement: "left",
      closable: false,
      visible: drawerState,
    ...
    })), Mail_jsx(AppModuleHeader["a" /* default */], {
    ...
    }, Mail_jsx(CircularProgress["a" /* default */], null)) : this.displayMail(currentMail, folderMails, noContentFoundMessage), Mail_jsx(Compose["a" /* default */], {
      open: composeMail,
      user: user,
      onClose: this.handleRequestClose.bind(this),
      onMailSend: this.onMailSend.bind(this)
    })))), showMessage && external_antd_["message"].info(Mail_jsx("span", {
      id: "message-id"
...
/* harmony default export */ var routes_Mail_0 = __webpack_exports__["default"] = (Mail_Mail);
